...
{
    [CustomEditor(typeof(TextureTargetUnityEvent))]
    [CanEditMultipleObjects]
    public class TextureTargetUnityEventEditor : BaseEditor
    {
        ...
        private TextureTargetUnityEvent m_target;

        private TextureTargetUnityEvent Target
        {
            get
            {
                if (m_target != null) return m_target;
                m_target = (TextureTargetUnityEvent)target;
                return m_target;
            }
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            DrawHeader(Styles.GetStyle(Styles.StyleName.ComponentHeaderTextureTargetUnityEvent), MenuUtils.TextureTargetUnityEvent_Manual, MenuUtils.TextureTargetUnityEvent_YouTube);
